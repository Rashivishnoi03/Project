            ...
            <div className="relative ml-3">
              ...
              {isProfileDropdownOpen && (
                <div className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                 <a to="/profile"  className="block px-4 py-2 text-sm text-gray-700">
                    Your Profile
                    
                  </a>
                  <a to="/settings" className="block px-4 py-2 text-sm text-gray-700">
                    Settings
                  </a>
                  <a to="/signout" className="block px-4 py-2 text-sm text-gray-700">
                    Sign out
                  </a>
                </div>
              )}
